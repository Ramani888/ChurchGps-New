...
export default {
  ...
  chat: 'Discussion',
  friends: 'Amis',
  enterUsernameOrRefferal: 'Entrez @nom d’utilisateur ou code de parrainage',
  info: 'Info',
  members: 'Membres',
  leave: 'Quitter',
  report: 'Signaler',
  ...
  delete: 'Supprimer',
  block: 'Bloquer',
  enterReport: 'Entrez une courte description du problème',
  send: 'Envoyer',
  actionHistory: 'Historique des actions',
  memberPermission: 'Permissions du membre',
  ...
  addNewAdmins: 'Ajouter de nouveaux administrateurs',
  startVoiceChat: 'Démarrer le chat vocal',
  createPoll: 'Créer un sondage',
  removeAdmins: 'Supprimer les administrateurs',
  modifyCalender: 'Modifier le calendrier',
  back: 'Retour',
  transferOwnership: 'Transférer la propriété',
  transferringOwner: 'Transfert de propriété',
  transferrinText:
    'Vous transférez la propriété du groupe et donnez à cet utilisateur le contrôle total des paramètres.',
  memberPermissions: 'Permissions des membres',
  searchPlaceholder: 'Rechercher ...',
  select: 'Sélectionner',
  communityInformationText2:
    'Si vous organisez, invitez, offrez de l’aide ou demandez du soutien — c’est l’endroit idéal.',
  addFriends: 'Ajouter des amis',
  showMessageFrom: 'Afficher les messages de',
  startGroupVoiceChat: 'Démarrer le chat vocal de groupe',
  endVoiceChat: 'Terminer le chat vocal',
  generalDiscussion: 'Discussion générale',
  anyoneCanSpeak: 'Tout le monde peut parler',
  givePermissionToSpeak: 'Donner la permission de parler',
  createPoll: 'Créer un sondage',
  question: 'Question',
  options: 'Options',
  ...
  kick: 'Exclure',
  mute: 'Muet',
  allowToSpeak: 'Autoriser à parler',
  leave: 'Quitter',
  minimize: 'Réduire',
  speakRequest: 'Demande de parole',
};
