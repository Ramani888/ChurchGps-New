...
export default {
  ...
  chat: 'Chat',
  friends: 'Freunde',
  enterUsernameOrRefferal: 'Benutzername @ oder Empfehlungscode eingeben',
  info: 'Info',
  members: 'Mitglieder',
  leave: 'Verlassen',
  report: 'Melden',
  ...
  delete: 'Löschen',
  block: 'Blockieren',
  enterReport: 'Kurze Problembeschreibung eingeben',
  send: 'Senden',
  actionHistory: 'Aktionsverlauf',
  memberPermission: 'Mitgliederrechte',
  ...
  addNewAdmins: 'Neue Admins hinzufügen',
  startVoiceChat: 'Sprachchat starten',
  createPoll: 'Umfrage erstellen',
  removeAdmins: 'Admins entfernen',
  modifyCalender: 'Kalender ändern',
  back: 'Zurück',
  transferOwnership: 'Eigentum übertragen',
  transferringOwner: 'Eigentum wird übertragen',
  transferrinText:
    'Sie übertragen die Gruppenleitung und geben diesem Benutzer volle Kontrolle über alle Einstellungen.',
  memberPermissions: 'Mitgliederrechte',
  searchPlaceholder: 'Suchen ...',
  select: 'Auswählen',
  communityInformationText2:
    'Wenn Sie organisieren, einladen, helfen oder Unterstützung suchen — dies ist der richtige Ort.',
  addFriends: 'Freunde hinzufügen',
  showMessageFrom: 'Nachrichten anzeigen von',
  startGroupVoiceChat: 'Gruppen-Sprachchat starten',
  endVoiceChat: 'Sprachchat beenden',
  generalDiscussion: 'Allgemeine Diskussion',
  anyoneCanSpeak: 'Jeder kann sprechen',
  givePermissionToSpeak: 'Sprechberechtigung erteilen',
  createPoll: 'Umfrage erstellen',
  question: 'Frage',
  options: 'Optionen',
  ...
  kick: 'Entfernen',
  mute: 'Stummschalten',
  allowToSpeak: 'Sprechen erlauben',
  leave: 'Verlassen',
  minimize: 'Minimieren',
  speakRequest: 'Sprechanfrage',
};
