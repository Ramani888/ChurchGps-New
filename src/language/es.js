...
export default {
  ...
  createOrJoinString: 'Crear o Unirse - Reuniones en cualquier lugar',
  ...
  chat: 'Chat',
  friends: 'Amigos',
  enterUsernameOrRefferal: 'Ingrese @usuario o código de referencia',
  info: 'Información',
  members: 'Miembros',
  leave: 'Salir',
  report: 'Reportar',
  ...
  delete: 'Eliminar',
  block: 'Bloquear',
  enterReport: 'Ingrese una breve descripción del problema',
  send: 'Enviar',
  actionHistory: 'Historial de acciones',
  memberPermission: 'Permisos del miembro',
  ...
  addNewAdmins: 'Agregar nuevos administradores',
  startVoiceChat: 'Iniciar chat de voz',
  createPoll: 'Crear encuesta',
  removeAdmins: 'Eliminar administradores',
  modifyCalender: 'Modificar calendario',
  back: 'Atrás',
  transferOwnership: 'Transferir propiedad',
  transferringOwner: 'Transfiriendo propiedad',
  transferrinText:
    'Está transfiriendo la propiedad del grupo y otorgando control total de la configuración a este usuario.',
  memberPermissions: 'Permisos de miembros',
  searchPlaceholder: 'Buscar ...',
  select: 'Seleccionar',
  communityInformationText2:
    'Si estás organizando, invitando, ofreciendo ayuda o solicitando apoyo — este es el lugar indicado.',
  addFriends: 'Agregar amigos',
  showMessageFrom: 'Mostrar mensajes de',
  startGroupVoiceChat: 'Iniciar chat de voz grupal',
  endVoiceChat: 'Finalizar chat de voz',
  generalDiscussion: 'Discusión general',
  anyoneCanSpeak: 'Cualquiera puede hablar',
  givePermissionToSpeak: 'Dar permiso para hablar',
  createPoll: 'Crear encuesta',
  question: 'Pregunta',
  options: 'Opciones',
  ...
  kick: 'Expulsar',
  mute: 'Silenciar',
  allowToSpeak: 'Permitir hablar',
  leave: 'Salir',
  minimize: 'Minimizar',
  speakRequest: 'Solicitud para hablar',
};
