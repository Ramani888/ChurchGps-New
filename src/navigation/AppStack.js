...
const AppStack = () => {
  return (
    ...
    >
      ...
      <Stack.Screen name={screenName.forgotPassword} component={screen.ForgotPasswordScreen} />
      <Stack.Screen name={screenName.myAccount} component={screen.MyAccountScreen} />
      {/* app */}
      <Stack.Screen name={screenName.tabStack} component={BottomTabNav} />
      <Stack.Screen name={screenName.termsAndPrivacy} component={screen.TermsAndPrivacy} />
      <Stack.Screen name={screenName.introVideo} component={screen.IntroVideo} />
      <Stack.Screen name={screenName.recordVideo} component={screen.RecordVideoScreen} />
      <Stack.Screen name={screenName.information} component={screen.InformationScreen} />
      <Stack.Screen name={screenName.createGathering} component={screen.CreateGatheringScreen} />
      ...
      <Stack.Screen name={screenName.memberProfilescreen} component={screen.MemberProfileScreen} />
    </Stack.Navigator>
  );
};
